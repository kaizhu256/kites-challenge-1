...
(function moduleTestShared() {
  ...
  var local = {
    ...
    _extra_psrse_am_pm_correctly_test: function (onEventError) {
      ...
      EXPORTS.assert(required.kites_hours.parse('7:00') === '');
      EXPORTS.assert(required.kites_hours.parse('7:00 to 11:00') === '');
      EXPORTS.assert(required.kites_hours.parse('Sunday: 7:00 am to 11:00 pm') === 'S0:0700-2300');
      onEventError();
    },

    _Parses_simple_sentences_correctly_test: function (onEventError) {
      console.log('running test - Parses simple sentences correctly');
      EXPORTS.assert(required.kites_hours.parse('Sunday: 7:00 to 11:00') === 'S0:0700-1100');
      EXPORTS.assert(required.kites_hours.parse('Sunday: 15:00 to 1:00') === 'S0:1500-2500');
      EXPORTS.assert(required.kites_hours.parse('Sun: 07:00-00:00') === 'S0:0700-2400');
      onEventError();
    },
    ...
    _Parses_THROUGH_sentences_correctly_test: function (onEventError) {
      ...
      EXPORTS.assert(required.kites_hours.parse('Mon-Sun: 12:30-01:00') === 'S0-6:1230-2500');
      EXPORTS.assert(required.kites_hours.parse('Mon to Sun: 06:30 - 22:30') === 'S0-6:0630-2230');
      EXPORTS.assert(required.kites_hours.parse('Fri to Tue: 06:30 - 22:30') === 'S5-2:0630-2230');
      EXPORTS.assert(required.kites_hours.parse('Mon - Wed: 07:00-01:00') === 'S1-3:0700-2500');
      onEventError();
    },

    _Parses_AND_sentences_correctly_test: function (onEventError) {
      console.log('running test - Parses AND sentences correctly');
      EXPORTS.assert(required.kites_hours.parse('Mon-Thu & Sun: 09:30-22:30') === 'S0-4:0930-2230');
      EXPORTS.assert(required.kites_hours.parse('Fri-Sat & PH: 09:30-23:00') === 'S5-6:0930-2300');
      onEventError();
    },
    ...
    _Parses_sentences_with_multiple_times_correctly_test: function (onEventError) {
      ...
      EXPORTS.assert(required.kites_hours.parse('Mon-Fri: 11:45-16:30; 17:45-23:30') === 'S1-5:1145-1630,1745-2330');
      EXPORTS.assert(required.kites_hours.parse('Monday to Sunday: 12:00-15:00, 18:00-22:00') === 'S0-6:1200-1500,1800-2200');
      onEventError();
    },
    ...
    _Deals_with_strange_Unicode_characters_correctly_test: function (onEventError) {
      ...
      EXPORTS.assert(required.kites_hours.parse('Mon：18:00-00:00') === 'S1:1800-2400');
      EXPORTS.assert(required.kites_hours.parse('Sat & Sun: 12:00-14:30；18:00-23:00') === 'S6-0:1200-1430,1800-2300');
      EXPORTS.assert(required.kites_hours.parse('Mon to Fri: 6:30 – 20:30') === 'S1-5:0630-2030');
      onEventError();
    },
    ...
    _Tokenizes_multiline_hours_correctly_test: function (onEventError) {
      ...
      EXPORTS.assert(required.kites_hours.parse('Mon.-Sat.: 11:30-22:30; Sun.: 10:30-22:30') === 'S0:1030-2230;1-6:1130-2230');
      EXPORTS.assert(required.kites_hours.parse('Sun.-Thur. 11:00-23:00, Fri.-Sat. 11:00-00:00') === 'S0-4:1100-2300;5-6:1100-2400');
      onEventError();
    },
    ...
    _Parses_complex_sentences_correctly_test: function (onEventError) {
      ...
      EXPORTS.assert(required.kites_hours.parse('Mon-Sun\nBreakfast 07:00-11:00\nLunch 11:30-14:30\nTea 14:00-18:00\nSun-Thu Dinner 18:30-22:30\nFri & Sat Dinner 18:30-23:30') === 'S0-4:0700-1100,1130-1800,1830-2230;5-6:0700-1100,1130-1800,1830-2330');
      onEventError();
    },

    _Custom_tests_test: function (onEventError) {
      console.log('running test - Custom tests');
      EXPORTS.assert(required.kites_hours.parse('Mon-Sun: 06:00-23:00\n(Tea: 06:00-16:00)') === 'S0-6:0600-2300');
      EXPORTS.assert(required.kites_hours.parse('Mon-Sat: 11:00-21:00 until 300 quotas soldout') === 'S1-6:1100-2100');
      EXPORTS.assert(required.kites_hours.parse('Monday to Sunday & Public Holiday:\n12:00-15:00, 18:00-00:00') === 'S0-6:1200-1500,1800-2400');
      EXPORTS.assert(required.kites_hours.parse('Restaurant Mon-Sun: 06:30-23:00\nBar Mon-Sun: 15:00-00:00\nBe on Canton Mon-Sun: 12:00-00:00') === 'S0-6:0630-2400');
      EXPORTS.assert(required.kites_hours.parse('Mon-Sat: 2300-2500,0600-0800') === 'S1-6:0600-0800,2300-2500');
      EXPORTS.assert(required.kites_hours.parse('Mon-Sat: 0000-2300,2301-2800') === 'S1-6:0000-2300,2301-2800');
      EXPORTS.assert(required.kites_hours.parse('Fri-Sat: 0000-2300, Mon: 0000-2300') === 'S1,5-6:0000-2300');
      EXPORTS.assert(required.kites_hours.parse('Fri-Sat: 0000-2300, Mon: 0000-2301') === 'S1:0000-2301;5-6:0000-2300');
      onEventError();
    },

    _Chinese_test: function (onEventError) {
      console.log('running test - Chinese');
      EXPORTS.assert(required.kites_hours.parse('Mon.-Sun.: 12:00-22:30') === 'S0-6:1200-2230');
      EXPORTS.assert(required.kites_hours.parse('星期一至日: 12:00-22:30') === 'S0-6:1200-2230');
      EXPORTS.assert(required.kites_hours.parse('Mon.-Sat.: 12:00-23:00') === 'S1-6:1200-2300');
      EXPORTS.assert(required.kites_hours.parse('星期一至六: 12:00-23:00 ') === 'S1-6:1200-2300');
      EXPORTS.assert(required.kites_hours.parse('Mon.-Sun.: 12:00-14:30, 19:00-22:30') === 'S0-6:1200-1430,1900-2230');
      EXPORTS.assert(required.kites_hours.parse('星期一至日: 12:00-14:30, 19:00-22:30') === 'S0-6:1200-1430,1900-2230');
      EXPORTS.assert(required.kites_hours.parse('Mon to Sat: 12:00 – 14:30; 18:30 – 23:00\nSun: 12:00 – 15:00; 18:30 – 23:00') === 'S0:1200-1500,1830-2300;1-6:1200-1430,1830-2300');
      EXPORTS.assert(required.kites_hours.parse('星期一至六：12:00 – 14:30; 18:30 – 23:00\n星期日：12:00 – 15:00; 18:30 – 23:00') === 'S0:1200-1500,1830-2300;1-6:1200-1430,1830-2300');
      EXPORTS.assert(required.kites_hours.parse('Mon.-Fri.: 12:00-14:30； 18:00-22:30\nSat.-Sun.&Public Holidays: 11:30-15:00; 18:00-22:30') === 'S6-0:1130-1500,1800-2230;1-5:1200-1430,1800-2230');
      EXPORTS.assert(required.kites_hours.parse('星期一至五：12:00-14:30； 18:00-22:30\n星期六、日及公眾假期：11:30-15:00； 18:00-22:30') === 'S6-0:1130-1500,1800-2230;1-5:1200-1430,1800-2230');
      EXPORTS.assert(required.kites_hours.parse('Mon.-Sat.: 11:30-14:30, 18:00-22:30; Sun.&Public Holidays: 11:00-14:30, 18:00-22:30') === 'S0:1100-1430,1800-2230;1-6:1130-1430,1800-2230');
      EXPORTS.assert(required.kites_hours.parse('星期一至六: 11:30-14:30, 18:00-22:30; 星期日及公眾假期: 11:00-14:30, 18:00-22:30') === 'S0:1100-1430,1800-2230;1-6:1130-1430,1800-2230');
      EXPORTS.assert(required.kites_hours.parse('Breakfast (Weekday): 07:00-10:00\nBreakfast (Sunday and Public Holiday): 07:00-10:30\nLunch: 12:00-14:30\nDinner: 18:00-22:00\nVerandah Café : 07:00-23:00 (cakes and sandwiches only available from 14:00-18:00 daily)') === 'S0:0700-2300;1-5:0700-1000');
      EXPORTS.assert(required.kites_hours.parse('早餐(星期一至六): 07:00-10:00\n早餐(星期日及公眾假期): 07:00-10:30\n午餐: 12:00-14:30\n晚餐: 18:00-22:00\n露台咖啡廳: 07:00-23:00 (糕點及三文治於14:00-18:00供應)') === 'S0:0700-2300;1-6:0700-1000');
      EXPORTS.assert(required.kites_hours.parse('星期一至星期日: 07:00-21:00') === 'S0-6:0700-2100');
      onEventError();
    }
